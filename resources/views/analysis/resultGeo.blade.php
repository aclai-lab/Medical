...
<script type="text/javascript">
    ...
    var result_country = @json($result_country);
    ...
    for (var i = 0; i < result_name.length; i++)
    {
      ...
      if(result_country[i].country != null)
      {
        labels.push(result_name[i].name+' '+result_country[i].country);
        // string = result_name[i].name+' '+result_country[i].pubblication_year;
      }
      else
      {
    ...
    var lenI = lineChart[0].length;//lunghezza vettore interno (numero di classi)
    ...
    for(var i = 0; i < len; i++)
    {
      ...
      if(lineChart[i].length != 0)
      {
        ...
        // console.log(lineChart[i][0].name +" "+ lineChart[i][0].country+" valore i = "+i);
      
        datasetsvals.push(
          {
            label: lineChart[i][0].name +" "+ lineChart[i][0].country,
            data: dataLineChart,
            borderWidth: 2,
            lineTension:0,
            fill: false,
