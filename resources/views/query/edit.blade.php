...
<form action="{{URL::action('QueryController@update',$query)}}" method="POST">

    <a href="{{URL::action('QueryController@index')}}" class="btn btn-secondary float-right ml-2">Back</a>
    ...
    <textarea name="description_long" >{{$query->description_long}}</textarea>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="description_short" value="{{$query->description_short}}">
        {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
    </div>
    ...
    @foreach ($label as $item)
        ...
        <div class="form-group">
            ...
            <input type="text" class="col-md-11 " id="label_string" name="label_string" value=""><button class="btn btn-secondary ml-2" type="button" id="addLabel" onclick="addlabel()">ADD</button>
            <div class="mt-2 mb-2">
                <textarea id="stringlabel" class="query-box-input col-md-11" name="label" placeholder="Enter / edit your label here">{{$item->name}};</textarea>
    ...
    {{-- <div class="form-group">
        ...
        <input type="text" class="form-control" name="apikey" value="{{$query->apiKey}}">
    </div> --}}
    ...
    <div class="border border-dark my-2">
        ...
        <div class="pubmedQuery  " style="display: inline" id="PubmedQuery">
            ...
            <div class="queryBox"><!--div del quadrato -->
                ...
                <div class="query-box-wrapper mt-2 ml-2 mb-2">
                    <textarea id="string" class="query-box-input col-md-11" name="string" placeholder="Enter / edit your search query here" >{{$query->string}}</textarea>
        ...
        <div class="Scopus" style="display: none;" id="ScopusQuery">
    ...
    $("#label_string").focus(function() {
        var alerted = localStorage.getItem('alerted');
        if(alerted != 'yes'){
            alert("changing the labeling will erase the current traning");
            localStorage.setItem('alerted','yes');
        }
    });

    $("#stringlabel").focus(function() {
        var alerted = localStorage.getItem('alerted');
        if(alerted != 'yes'){
            alert("changing the labeling will erase the current traning");
            localStorage.setItem('alerted','yes');
